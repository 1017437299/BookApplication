...
import bnuz.it.lq.bookapplication.BookActivity;
import bnuz.it.lq.bookapplication.BookListResult;
import bnuz.it.lq.bookapplication.R;
...
public class BookListActivity extends AppCompatActivity {
    ...
    private class BookListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                view = getLayoutInflater().inflate(R.layout.book_list_item, null);
                viewHolder.mNameTextView = (TextView) view.findViewById(R.id.tv_book_name);
                viewHolder.mButton = (Button) view.findViewById(R.id.bt_continue);
